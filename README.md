...
Все изображения на выходе гарантированно имеют формат JPEG с встроенным ICC профилем sRGB. Подробности о цветовом менеджменте, ограничениях и best practices см. в [docs/COLOR_MANAGEMENT.md](docs/COLOR_MANAGEMENT.md).
